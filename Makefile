...
realtest: build/main
	...
	./build/main -7 -C --sb 32767 --lb 32767 -i data/train.txt -o data/train.77 && ./build/main -7 -D --sb 32767 --lb 32767 -i data/train.77 -o data/train.out; \
	...
	./build/main -p -C -n 8 --sb 32767 --lb 32767 -i data/train.txt -o data/train.77p && ./build/main -p -D --sb 32767 --lb 32767 -i data/train.77p -o data/train.out; \
	...
	./build/main -8 -C --ds 32767 -i data/train.txt -o data/train.78 && ./build/main -8 -D --ds 32767 -i data/train.78 -o data/train.out; \
	...
	./build/main -w -C --ds 32767 -i data/train.txt -o data/train.w && ./build/main -w -D --ds 32767 -i data/train.w -o data/train.out; \
